...
* Know the other model
* Understand the concept of “layers”. Distinguish between the upper and lower level layers.
...
* Understand the individual concepts and functions for layers 1, 2, 3, and 4 (lower layers) of the OSI model.
* See References Under 2.1
* Understand the comparative layers of the TCP/IP model and the OSI Model. The layers are often used interchangeably in discussions.
* See References Under 2.1

* Section 3: Addressing & IP Notation
* (3.1) Understand the use of addressing for network interface identification.
* https://en.wikipedia.org/wiki/MAC_address 
* https://en.wikipedia.org/wiki/IP_address 
* https://en.wikipedia.org/wiki/Network_interface_controller  
* Understand the use of addressing for routing.
* http://blog.pluralsight.com/ip-addressing-routing-ip-address-architecture
* Understand the difference between network layer and data link layer addressing.
* http://www.tcpipguide.com/free/t_NetworkLayerLayer3.htm
* Understand the concept and use of public and private addressing.
* https://www.iplocation.net/public-vs-private-ip-address 
* https://en.wikipedia.org/wiki/Private_network  
* https://en.wikipedia.org/wiki/IP_address 
* (3.5) Understand the concept of static and dynamic addressing.
* http://whatismyipaddress.com/dynamic-static
* (3.6) Proficient in the use of IP and MAC address format/notation in the correct context.
...
* Proficient in the use of CIDR notation.
* https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing
* Understand the limitations of IPV4 address space and basic awareness of IPV6 goals and implementations/road blocks.
* http://www.tcpipguide.com/free/t_IPv6AddressandAddressNotationandPrefixRepresentati.htm 
* Understanding of the governing bodies for assignment of IP and MAC address blocks.
* https://en.wikipedia.org/wiki/Institute_of_Electrical_and_Electronics_Engineers
* https://en.wikipedia.org/wiki/ICANN

* Section 1-3 Assessment:   Quiz 1: Network Models

* Section 4: Addressing & IP Notation
* (4.1) Understand the function(s) of Ethernet switches/bridges.
* https://en.wikipedia.org/wiki/Network_switch 
* (4.2) Understand the basic function of a router.
* http://www.tcpipguide.com/free/t_IPRoutesandRoutingTables.htm
* https://drive.google.com/open?id=0B6XeW7tp_mQzM1IwbDFLLWN6cEU 
* (4.3) Understand the fundamental differences between switches/bridges and routers.
* See References for (4.1) and (4.2) 
* (4.4) Understand the interfaces and addresses associated with switches.
* See Reference (4.1)
* (4.5) Understand the interfaces and addresses associated with routers.
* See Reference (4.2)
* (4.6) Have a conceptual understanding of a routing table.
* http://www.tcpipguide.com/free/t_IPRoutesandRoutingTables.htm 
